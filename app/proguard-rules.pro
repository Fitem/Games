...
-keep class com.zsft.thai.base.helper.** { *; }
-keep class com.zsft.thai.base.stats.** { *; }

#-keep interface * extends com.jaydenxiao.common.base.BaseModel{ *; }
...
# photoPicker library module
-keep class com.yuyh.library.imgsel.** {*;}
